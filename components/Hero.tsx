    ...
    <section>
      <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className="flex-shrink-0">
            <img src="https://picsum.photos/seed/supriyadi-dev/400/400" alt="Supriyadi's profile" className="rounded-full w-64 h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 object-cover border-4 border-slate-700 shadow-lg"/>
        </div>
      </div>
    </section>
  );
